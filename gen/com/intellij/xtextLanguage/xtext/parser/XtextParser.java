...
public class XtextParser implements PsiParser, LightPsiParser {
  ...
  public static boolean CrossReference(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CROSS_REFERENCE, "<cross reference>");
    r = consumeToken(b, "[");
    r = r && TypeRef(b, l + 1);
  ...
  public static boolean GeneratedMetamodel(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, GENERATED_METAMODEL, "<generated metamodel>");
  ...
  public static boolean NegatedToken(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, NEGATED_TOKEN, "<negated token>");
    r = consumeToken(b, "!");
  ...
  public static boolean ParenthesizedAssignableElement(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, PARENTHESIZED_ASSIGNABLE_ELEMENT, "<parenthesized assignable element>");
    r = consumeToken(b, "(");
  ...
  public static boolean ParenthesizedCondition(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, PARENTHESIZED_CONDITION, "<parenthesized condition>");
    r = consumeToken(b, "(");
    r = r && Disjunction(b, l + 1);
    r = r && consumeToken(b, ")");
    exit_section_(b, l, m, r, false, null);
  ...
  public static boolean ParenthesizedTerminalElement(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, PARENTHESIZED_TERMINAL_ELEMENT, "<parenthesized terminal element>");
    r = consumeToken(b, "(");
  ...
  public static boolean ReferencedMetamodel(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, REFERENCED_METAMODEL, "<referenced metamodel>");
  ...
  public static boolean UntilToken(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, UNTIL_TOKEN, "<until token>");
    r = consumeToken(b, "->");
    r = r && TerminalTokenElement(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
